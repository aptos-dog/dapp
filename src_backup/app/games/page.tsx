...
export default function Page() {
  const games = [
    {
      title: "Dropdown Bomb",
      icon: <Bomb className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/dropdown-bomb",
      desc: "Pick items, but avoid the bomb!",
    },
    {
      title: "Spin the Wheel",
      icon: <RotateCcw className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/spin-the-wheel",
      desc: "Try your luck and win XP rewards.",
    },
    {
      title: "Memory Flip",
      icon: <Brain className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/memory-flip",
      desc: "Test your memory and earn XP.",
    },
    {
      title: "Word Guess Game",
      icon: <Map className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/word-guess",
      desc: "Guess the location for XP!",
    },
    {
      title: "Tower Stack",
      icon: <Layers className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/tower-stack",
      desc: "Stack the blocks perfectly to earn XP.",
    },
    {
      title: "Whack-a-Dog",
      icon: <Dog className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/whack-a-dog",
      desc: "Whack the sneaky dogs to score XP!",
    },
    {
      title: "Simon Says",
      icon: <Star className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
      href: "/games/simon-says",
      desc: "Follow the sequence and test your memory!",
    },
    {
      title: "Quick Tap Reflex",
      icon: <Gamepad2 className="w-14 h-14 text-yellow-400 drop-shadow-[0_0_15px_rgba(255,255,0,0.9)]" />,
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black text-white relative overflow-hidden">
      ...
      <div className="flex justify-between items-center px-6 mt-4 z-10">
        <Link
          href="/game-hub"
      ...
      {/* Dashboard Content */}
      <main className="flex-grow flex flex-col items-center justify-center px-6 py-10 relative z-10">
        <motion.h1
        ...
        >
          ...
          <p className="text-gray-200 leading-relaxed mb-3">
            Step into the <span className="font-bold text-yellow-400">$APTDOG</span> universe and
            explore thrilling blockchain-powered games. Each challenge is built to
            test your skills while earning XP that pushes you up the leaderboard.
          </p>
          <p className="text-yellow-300 font-semibold text-lg">
            Play, compete, and claim your place as the ultimate Aptos Dog gamer!
          </p>
        </motion.div>
